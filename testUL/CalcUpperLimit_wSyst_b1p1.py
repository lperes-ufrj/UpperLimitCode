...
for i in range(0,4): #Each BDM sample gamma and mass value 
    ...
    poi_m05 = np.linspace(1e-7,1.5e-6,STEPS_PROBING_GZ4)
    poi_m10 = np.linspace(1e-7,1e-5,STEPS_PROBING_GZ4)
    poi_m20 = np.linspace(1e-7,1e-5,STEPS_PROBING_GZ4)
    poi_m40 = np.linspace(1e-7,5e-5,STEPS_PROBING_GZ4)
